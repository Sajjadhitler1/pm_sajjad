...
4⃣ دستور /creator که نشان دهنده ساخته شدن ربات شما توسط @PMresanCreator_roBot است از ربات شما حذف میشود. 😉
5⃣ در صورت اضافه شدن امکانات جدید به ربات پی وی رسان ربات های VIP اولویت اول را دارند. 🤖

🔰 هزینه تبدیل به ربات (VIP) سالیانه 3,000 تومان میباشد
";
