<?php
define('API_KEY','328865958:AAENbuxVl5iwTfNFTdQyNmgioDWxnR6vLNI');
//----######------
...
$token = $textmessage ;
	...
	$ok = $resultb["ok"];
		...
		file_get_contents("http://api.pwrtelegram.xyz/bot".$token."/setwebhook?url=https://pmsajjadhitler.teleagent.ir/ webhook/bots/$un/index.php");
...
🔹
ساخت ربات از دکمه ی 🔄 ساخت ربات استفاده نمایید.📢 @"$userbot"",
  'parse_mode'=>'MarkDown',
         'reply_markup'=>json_encode([
             'keyboard'=>[
                [
